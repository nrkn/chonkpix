...
export declare const setIndices: (tilemap: TileMap, indices: Maybe<number>[], animated: Set<number>, x: number, y: number, w: number, h: number, elapsed: number, emptyId: number) => void;
