...
export declare const drawRotatedAndPointScaled: (src: ImageData, srcCx: number, srcCy: number, dest: ImageData, destCx: number, destCy: number, radians: number, srcScale?: number) => ImageData;
